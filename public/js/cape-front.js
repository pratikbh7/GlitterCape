function cape_animation(){
	const slide_objects = document.getElementsByClassName('cape_slides');
	...
	const slide_left = document.querySelector('.next-left-arrow'),
 		slide_right = document.querySelector('.next-right-arrow');
	...
	slide_right.addEventListener( "click", function(){
		...
		if( slide_state[ mid_index ] !== ( slide_length - 1 ) ){
			...
			if( slide_length > 5){
				...
				end_value = ( end_value > ( slide_length - 1 ) ) ? false : end_value;
	...
	slide_left.addEventListener( "click", function(){
		...
		if( slide_state[ mid_index ] !== 0 ){
			...
			if( slide_length > 5){
				start_value = slide_state[ last_index ] + 1;
				start_value = ( start_value > ( slide_length - 1 ) ) ? false : start_value;
